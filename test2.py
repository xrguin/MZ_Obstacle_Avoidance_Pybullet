...
class RobotSimulation:
    ...
    def simulate_step(self, current_sample):
        ...
        # Store previous forces for reference
        prev_forces_robot2 = {
    ...
    def run_simulation(self):
        ...
        for i in tqdm(range(self.samples), desc="Running simulations"):
            ...
            # Run simulation
            self.run_matplotlib_simulation(filename=f'test_{i}')
...
def main():
    ...
    sim.samples = len(uncertainty_params_robot2)
    sim.run_simulation()
